...
A_pub = (5704, 7355)
B_priv = 5912
shared_point = elliptic_curve_scalar_multiplication(B_priv, A_pub, curve)
x_coord = str(shared_point[0])
key = SHA1(x_coord)

print("Derived AES key:", key)

#S = elliptic_curve_scalar_multiplication(B_priv, A_pub, curve)
#print(S)
# Test out scalar multiplication
#for p in [A_pub, B_priv]: print(elliptic_curve_scalar_multiplication(5, p, curve))